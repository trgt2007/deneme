...
export interface ISushiSwapV2RouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface ISushiSwapV2Router extends BaseContract {
  connect(runner?: ContractRunner | null): ISushiSwapV2Router;
  waitForDeployment(): Promise<this>;

  interface: ISushiSwapV2RouterInterface;
