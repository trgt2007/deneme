...
export interface ISushiSwapV2FactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allPairs"
      | "allPairsLength"
...
export interface ISushiSwapV2Factory extends BaseContract {
  connect(runner?: ContractRunner | null): ISushiSwapV2Factory;
